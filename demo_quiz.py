...
class Question:
    ...
    def checkAnswer(self,answer):
        ...
        ## Koddaki doğru şıkkı geri çağırdık
        ## Koddaki doğru şık ile dışarıdan yazılan şık aynı ise True yazacak
...
q4 = Question(" En çok sevilen dili hangisidir?" , ["C#" , "python" , "javascript" , "java"], "python")
